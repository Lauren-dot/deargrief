...
class GriefSequence(db.Model):
    ...
    status = db.Column(db.String(50), db.ForeignKey("sequence_status.id"), nullable=False)
    ...
    prompts = db.Relationship("PromptSeries", backref="grief_sequence")
    sequence_status = db.Relationship("", backref="grief_sequence")
