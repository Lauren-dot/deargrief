...
@app.route("/previous_journal_entries/<int:grief_connection_id>", methods=["GET"])
@login_required
def gather_previous_entries(grief_connection_id):

    grief_connection=GriefConnection.query.get(grief_connection_id)

    return render_template("previous_journal_entries.html", grief_connection=grief_connection, previous_entries=grief_connection.journal_entries)
